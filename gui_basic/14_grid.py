...
#using grid = coordinate

#first line
#padx,pady -> length width 
#btn_f16 = Button(root,text="F16",width=5,height=2)
#however, pad does not give an opimally same space amount. So using
#height and width would be better to make same size of keys
btn_f16 = Button(root,text="F16",width=5,height=2)
btn_f17 = Button(root,text="F17",width=5,height=2)
btn_f18 = Button(root,text="F18",width=5,height=2)
btn_f19 = Button(root,text="F19",width=5,height=2)
#sticky fills the space you want (direction)
